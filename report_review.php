...
$i = query::decryptGet($_GET['i']);
$q = "select * from reviews where review_id =". $i;
query::checkGet($q);

query::update("insert into reports values(report_id, '$i', '$_POST[rad]', curdate(),0)");
?>
...
<div id="page">
    ...
    <p>
       <script>
           alert('Thanks for reporting, your report will be reviewed soon.');
