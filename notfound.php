            ...
            <div class="cover-wrapper cover-no-buttons">
                ...
                <div data-height="cover" class="caption bottom-0">
                    <div class="caption-center">
                        <h1 class="color-white center-text fa-7x uppercase bolder bottom-20 top-20">404</h1>
                        <h2 class="color-white center-text uppercase bolder bottom-30">Page Not Found</h2>
