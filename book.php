...
$barb_ser_ar = $query->extractArrayFromQuery("barbers_services", 'barb_ser_id');
...
if (isset($_SESSION['username'])) {
    ...
    barbers_services bs, services s where
...
$col = isset($_SESSION['username']) ? 'user_id' : 'temp_user_id';
$table1 = $table.'_cart';
