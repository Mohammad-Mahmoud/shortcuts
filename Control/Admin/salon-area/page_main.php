    ...
    <nav class="left-menu" left-menu>
        <div class="logo-container">
            <a href="index.php" class="logo">
                <h4 style="color: #000;"><?= admin::getSalonData('name') ?> </h4>
            </a>
        </div>
        <div class="left-menu-inner scroll-pane">
            <ul class="left-menu-list left-menu-list-root list-unstyled">
                ...
                <li>
                    <a class="left-menu-link" href="home.php?art=barbers">
                        <i class="left-menu-link-icon icmn-scissors"></i>
                        Barbers
                    </a>
                </li>
                ...
                <li>
                    <a class="left-menu-link" href="home.php?art=cal">
                ...
                <li>
                    <a class="left-menu-link" href="home.php?art=bookings">
                        <i class="left-menu-link-icon icmn-calendar-empty"></i>
                        <?php
                        $salon_id = admin::getSalonData('salon_id');
                        $n = query::numRows("SELECT * FROM actual_booking a, barbers b where 
                                        a.barber_id = b.barber_id and b.salon_id = '$salon_id' and readen = 0");
                ...
                <li>
                    <a class="left-menu-link" href="home.php?art=slides">
                ...
                <li>
                    <a class="left-menu-link" href="home.php?art=settings">
                ...
                ?>
                    <li class="left-menu-list-separator">
                    <li>
                        <a class="left-menu-link" href="home.php?art=barber_services&i=<?=$barb_id?>">
                            <i class="left-menu-link-icon icmn-earth"></i>
                            Services
                        </a>
                    </li>
                <?php
                ...
                <li>
                    <a class="left-menu-link" href="home.php?art=social">
                        <i class="left-menu-link-icon icmn-share2"></i>
                        Social
                    </a>
                </li>
                ...
                <div class="dropdown dropdown-avatar">
                    <a href="javascript: void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <span class="avatar" href="javascript:void(0);">
                            <?php
                            $img = admin::getSalonData('logo');
                            if ($img == '') {
                                echo '<img src="../assets/common/img/temp/avatars/no-photo.jpg" alt="">';
                            } else {
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="" role="menu">
                        <a class="dropdown-item" href="home.php?art=profile"> <?= admin::getSalonData('name') ?></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="home.php?art=change_password">Change password</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="home.php?art=change_logo">Change Logo</a>
