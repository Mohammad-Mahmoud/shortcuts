            ...
            <div class="col-xl-12">
                ...
                <div class="single-page-block-inner">
                    <div class="single-page-block-form">
                        ...
                        <br />
                        <form id="form-validation" name="form-validation" method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                            <div class="form-group">
                                <label class="form-label">Email</label>
                                <label id="l1" class="form-control-error" style="visibility:hidden;"></label>
                                <input id="validation-email"
                                       class="form-control" onFocus='$("#l1").css("visibility","hidden")'
