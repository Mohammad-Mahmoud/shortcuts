...
$(document).ready(function(){      
	...
	function init_template(){	
		...
		setTimeout(function(){
			$('.single-slider').owlCarousel({loop:false, margin:0, nav:false, lazyLoad:true, items:1, autoplay: false, autoplayTimeout:4000});		
			...
			$('.cover-slider').owlCarousel({loop:false, margin:0, nav:false, lazyLoad:true, items:1, autoplay: false, autoplayTimeout:4000});		
			$('.double-slider').owlCarousel({loop:false, margin:20, nav:false, lazyLoad:true, items:2, autoplay: false, autoplayTimeout:4000});		
			$('.cta-slider').owlCarousel({loop:false, margin:0, nav:false, autoHeight:true, lazyLoad:true, items:1, autoplay: false, autoplayTimeout:3500});		
